...
export const BASEURL = (axios.defaults.baseURL = isLocal
  ? "http://trade.bstchain.com/"
  : window.location.origin + "/"); //'http://39.104.119.155:9090/';
...
export const post = (url, data = {}) => {
  return new Promise((resolve, reject) => {
    axios
      .post(url, qs.stringify(data, { arrayFormat: "repeat" }))
      .then(response => {
        resolve(response.data);
      })
      .catch(err => {
...
export const request = function(url, data, successStatus = 0) {
