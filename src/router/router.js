...
export const otherRouter = {
    ...
    children: [
        ...
        { path: '/otc/custom/detail', title: '申诉详情', name: 'otc:custom:detail', component: resolve => { require(['@/views/otc/CustomDetail.vue'], resolve) } },
...
let findSlideArr = [
    ...
    { id: 197, path: 'chat', icon: 'ios-person', component: resolve => { require(['@/views/member/chat/index.vue'], resolve) } },
    ...
    { id: 192, path: 'CostomManage', icon: 'clipboard', component: resolve => { require(['@/views/otc/CustomManage.vue'], resolve) } },
    { id: 193, path: 'HandlerCustomManage', icon: 'clipboard', component: resolve => { require(['@/views/otc/HandlerCustomManage/index.vue'], resolve) } },
...
export let getRouter = function () {
    ...
    return formateUndefinedArr
}

export let appRouter = getRouter();
