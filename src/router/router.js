...
export const otherRouter = {
  ...
  children: [
    ...
    },
    {
      ...
      name: "member:fixed",
      component: resolve => {
        require(["@/views/member/fixed.vue"], resolve);
      }
    },
    {
    ...
    },
    {
      ...
      title: "申诉详情",
      name: "otc:custom:detail",
      component: resolve => {
        require(["@/views/otc/CustomDetail.vue"], resolve);
      }
    },
    {
...
let findSlideArr = [
  ...
  },
  {
    ...
    icon: "ios-person",
    component: resolve => {
      require(["@/views/member/chat/index.vue"], resolve);
    }
  },
  {
    id: 19,
  ...
  },
  {
    ...
    icon: "clipboard",
    component: resolve => {
      require(["@/views/otc/CustomManage.vue"], resolve);
    }
  },
  {
    id: 193,
    path: "HandlerCustomManage",
    icon: "clipboard",
    component: resolve => {
      require(["@/views/otc/HandlerCustomManage/index.vue"], resolve);
    }
  },
  {
    id: 159,
  ...
  },
  {
    ...
    icon: "ios-person",
    component: resolve => {
      require(["@/views/member/Account.vue"], resolve);
    }
  }
];
