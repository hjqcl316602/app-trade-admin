 ...
 * @LastEditTime: 2019-09-04 17:51:52
  ...
  <div id="main" class="app-main">
    ...
    <div class="memberCheckMask" v-show="memberCheckMask">
      <div class="wrapper">
        ...
        <Row class="img">
          ...
          <img
            :src="
              !memberCheckImgInfo.imgArr
                ? ''
                : Object.values(memberCheckImgInfo.imgArr[imgIndex])
            "
            alt=""
          />
          <span class="preStep" v-show="!!imgIndex" @click="imgIndex--"
            >上一步 <
          </span>
          <span class="nextStep" v-show="!(imgIndex === 2)" @click="imgIndex++">
            > 下一步</span
          >
        </Row>
        <Row class="btns">
          <Row v-show="imgIndex !== 2">
            <Col span="4" offset="10">
              <Button type="primary" long @click="cancelMemberCheck"
                >取消</Button
              >
            </Col>
          </Row>
          ...
          <Row v-show="imgIndex === 2">
            <Col span="4" offset="7">
              <Button type="info" long @click="memberPass(true)"
                >审核通过</Button
              >
            </Col>
            <Col span="4" offset="2">
              <Button type="error" long @click="memberPass(false)"
                >审核不通过</Button
              >
            </Col>
          </Row>
    ...
    <div class="businessCheckMask" v-show="businessCheckMask">
      <div class="wrapper">
        ...
        <Row class="title">
          <Col span="12" :class="{ active: !authImgIndex }"
            >① 个人数字资产证明</Col
          >
          <Col span="12" :class="{ active: !!authImgIndex }"
            >② 数字资产交易证明</Col
        ...
        <Row class="businessInfo">
          ...
          <Col span="8"
            >保证金：{{
              `${businessCheckInfo.amount}${businessCheckInfo.coinSymbol}`
            }}</Col
          >
        ...
        <Row class="img">
          ...
          <span
            class="preStep"
            v-show="!authImgStep"
            @click="switchAuthImg(true)"
            >上一步 <
          </span>
          <span
            class="nextStep"
            v-show="authImgStep"
            @click="switchAuthImg(false)"
          >
            > 下一步</span
          >
        </Row>
        ...
        <Row class="btns">
          <Row v-show="authImgStep">
            <Col span="4" offset="10">
              <Button type="primary" long @click="cancelBusinessCheck"
                >取消</Button
              >
            </Col>
          </Row>
          ...
          <Row v-show="!authImgStep">
            <Col span="4" offset="7">
              <Button type="info" long @click="businessPass(true)"
                >审核通过</Button
              >
            </Col>
            <Col span="4" offset="2">
              <Button type="error" long @click="businessPass(false)"
                >审核不通过</Button
              >
            </Col>
          </Row>
